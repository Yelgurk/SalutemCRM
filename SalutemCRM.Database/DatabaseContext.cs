...
public partial class DatabaseContext : DbContext
{
    ...
    private void DemoModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<WarehouseItem>().HasData(
            ...
            new WarehouseItem { Id = 12, InnerName = "Реле пусковое 48в dc", InnerCode = "a0012", CountRequired = 0, WarehouseCategoryForeignKey = 1 },
            new WarehouseItem { Id = 13, InnerName = "FX3U", InnerCode = "a0013", CountRequired = 0, WarehouseCategoryForeignKey = 4 },
            new WarehouseItem { Id = 14, InnerName = "OP280", InnerCode = "a0014", CountRequired = 0, WarehouseCategoryForeignKey = 4 },
            new WarehouseItem { Id = 15, InnerName = "SSPS3R3", InnerCode = "a0015", CountRequired = 0, WarehouseCategoryForeignKey = 4 },
            ...
            new WarehouseItem { Id = 23, InnerName = "Обичевка тм100", InnerCode = "a0023", CountRequired = 0, WarehouseCategoryForeignKey = 12 },
            new WarehouseItem { Id = 24, InnerName = "Обичевка тм100", InnerCode = "a0024", CountRequired = 0, WarehouseCategoryForeignKey = 12 }
        );
        ...
        modelBuilder.Entity<WarehouseSupply>().HasData(
            ...
            new WarehouseSupply { Id = 10, WarehouseItemForeignKey = 10, OrderForeignKey = 1, VendorName = "тест 10", VendorCode = "x0010", PriceRequired = 100.0, PriceTotal = 100.0, OrderCount = 45.0, InStockCount = 45.0, Currency = "BYN", RecordDT = DateTime.Now, DeliveryStatus = Delivery_Status.Completed },
            ...
            new WarehouseSupply { Id = 12, WarehouseItemForeignKey = 12, OrderForeignKey = 1, VendorName = "тест 12", VendorCode = "x0012", PriceRequired = 100.0, PriceTotal = 100.0, OrderCount = 45.0, InStockCount = 45.0, Currency = "BYN", RecordDT = DateTime.Now, DeliveryStatus = Delivery_Status.Completed },
            ...
            new WarehouseSupply { Id = 34, WarehouseItemForeignKey = 10, OrderForeignKey = 1, VendorName = "тест 34", VendorCode = "z0010", PriceRequired = 100.0, PriceTotal = 100.0, OrderCount = 33.0, InStockCount = 33.0, Currency = "BYN", RecordDT = DateTime.Now, DeliveryStatus = Delivery_Status.Completed },
            ...
            new WarehouseSupply { Id = 36, WarehouseItemForeignKey = 12, OrderForeignKey = 1, VendorName = "тест 36", VendorCode = "z0012", PriceRequired = 100.0, PriceTotal = 100.0, OrderCount = 33.0, InStockCount = 33.0, Currency = "BYN", RecordDT = DateTime.Now, DeliveryStatus = Delivery_Status.Completed },
